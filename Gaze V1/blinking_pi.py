...
def main():
    ...
    parser = argparse.ArgumentParser(description="Blink Detection Test (Pi)")
    _ = parser.parse_args()
    ...
    # You can use Preview.NULL if you don't want the DRM overlay
    picam2.start_preview(Preview.NULL)
    picam2.start()
    sleep(2)  # warm-up

    print("PiCamera2 started at 640x480")
